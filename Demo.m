...
addpath(genpath('.'));
NameList = {'emotions'};
% NameList = {'music_emotion','music_style','enron','scene','image','languagelog','emotions','yeast','birds','CAL500','arts','science','health','education',...
%     'social','ref'};
ratio = [0.5 1 1.5];
